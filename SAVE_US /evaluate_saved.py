...
# 		file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/graph_and_samples.p'
...
# 			print (it1,it2)
# 			dim=dimensions[it2]		
# 			file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/VERSE_'+str(dim)
# 			parameter_file=open(file_name, 'rb')
...
# 			print (it1,it2)
# 			dim=dimensions[it2]		
# 			file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/LE_'+str(dim)
# 			parameter_file=open(file_name, 'rb')
# 			X = pickle.load(parameter_file)
# 			parameter_file.close()
# 			X = X[node_l]
# 			embedding = LaplacianEigenmaps(d=dim)
# 			MAP_LE[it2][it1] = evaluation_measures.calc_map_us(embedding, X, node_l, train_digraph, test_digraph1)

# 		print ("evaluating for DEEPWALK")
# 		for it2 in xrange(len(dimensions)):
# 			print (it1,it2)
# 			dim=dimensions[it2]		
# 			file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/DEEPWALK_'+str(dim)
# 			parameter_file=open(file_name, 'rb')
# 			X = pickle.load(parameter_file)
# 			parameter_file.close()
# 			X = X[node_l]
...
# 			print (it1,it2)
# 			dim=dimensions[it2]		
# 			file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/n2vA_'+str(dim)
# 			parameter_file=open(file_name, 'rb')
# 			X = pickle.load(parameter_file)
# 			parameter_file.close()
# 			X = X[node_l]
...
# 			print (it1,it2)
# 			dim=dimensions[it2]		
# 			file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/n2vB_'+str(dim)
# 			parameter_file=open(file_name, 'rb')
# 			X = pickle.load(parameter_file)
# 			parameter_file.close()
# 			X = X[node_l]
...
# 			print (it1,it2)
# 			dim=dimensions[it2]		
# 			file_name='SAVER/'+fig_name[fig]+str(it1+1)+'/HOPE_'+str(dim)
# 			parameter_file=open(file_name, 'rb')
# 			X = pickle.load(parameter_file)
# 			parameter_file.close()
# 			X = X[node_l]
# 			embedding=HOPE(d=dim, beta=0.01)
# 			MAP_HOPE[it2][it1] = evaluation_measures.calc_map_us(embedding, X, node_l, train_digraph, test_digraph1)

# 	mean_LE = np.mean(MAP_LE,axis=1)
# 	std_LE = np.std(MAP_LE,axis=1)
...
# 	mean_HOPE = np.mean(MAP_HOPE,axis=1)
# 	std_HOPE = np.std(MAP_HOPE,axis=1)
...
for rat in xrange(len(ratios)):
	...
	for fig in xrange(len(fig_name)):
		...
		mean_HOPE = np.mean(AP_HOPE,axis=1)
		std_HOPE = np.std(AP_HOPE,axis=1)
		...
		mean_LE = np.mean(ROC_LE,axis=1)
		std_LE = np.std(ROC_LE,axis=1)
		...
		mean_HOPE = np.mean(ROC_HOPE,axis=1)
		std_HOPE = np.std(ROC_HOPE,axis=1)
